...
- **Location:** Pansvej 12, 2680 Solrød Strand, Danmark
- **Phone:** +45 91 56 85 28
- **Email:** julian.askoe@gmail.com
- **LinkedIn:** *(not recorded — add the URL here and in the 05/06 templates when available)*
- **GitHub:** *(not applicable)*
- **Status:** Newly graduated — MSc Human Nutrition defended Aug 2026; actively job seeking, available immediately
- **Constraints:** Based in Solrød Strand. Search covers all of Sjælland (Region Hovedstaden + Region Sjælland). No driving licence until approx. Nov 2026 — roles requiring a car are flagged for discussion, not excluded. Not open to night or shift work.
- **Titel:** Autoriseret klinisk diætist (dansk autorisation)
...
|--------|--------|-------------|------------|
| MSc, Human Nutrition | 2024-09 – 2026-08 | Københavns Universitet | Klinisk ernæring, forskningsdesign, protokoludarbejdelse, statistisk analyse (R-studio, GraphPad Prism), kritisk litteraturvurdering, molekylær onkologi |
...
> **Note for `/apply`:** the clinical experience below is **20 weeks of hospital placements plus thesis research**, not salaried employment. Never present it as employment history. Framed honestly it is still substantial — four departments, four specialities, and independent responsibility during the thesis study — and that honesty is itself credible to Danish hospital recruiters, who know exactly what a diætist-praktik is.

### Specialestuderende / forskningsansvarlig — Københavns Universitet, klinisk tillægsstudie (2024 – 2026)
København
- Udarbejdede udkast til tillægsprotokol og deltagerinformation, godkendt af Videnskabsetisk Komité (VEK); registrerede studiet på ClinicalTrials.gov
- Varetog participant-information, samtykkeindhentning og oplæring af 42 deltagere i kostregistrering, i koordination med forsøgslæge
- Forestod løbende opfølgning og telefonisk diætetisk vejledning af deltagerne efter behov
- Udtræk af lab-data og journaler fra Sundhedsplatformen; databearbejdning i VitaKost og REDCap; statistisk analyse i GraphPad Prism
- Udarbejdede diætetisk vejledningsmateriale til studiet; forbereder publicering som førsteforfatter
...
Glostrup · 4 uger
- Deltog i og overværede opstart af ernæringsterapi samt diætetisk praksis over for neurologiske patienter (bl.a. tetraplegi og Parkinson), spiseforstyrrelser og diabetes
...
### Klinisk diætetik
- Diætetisk vejledning og ernæringsterapi: **nefrologi** (fosfat-, kalium-, proteinregulering, prædialyse og dialyse), **kardiologi** (hjertesund/kolesterolsænkende kost), **endokrinologi** (type 1/2-diabetes, pancreasresektion), **neurologi** (tetraplegi, Parkinson), **onkologi** (NIS-faktorer, ernæringsrisiko), **perioperativ/ERAS-ernæring**, **artrose og vægttab**
- Kostregistrering og -beregning; ernæringsscreening og risikovurdering; dækningsgradsberegning
- Patientundervisning, individuel vejledning og gruppeundervisning
- Tværfagligt samarbejde med læger og sygeplejersker på afdelingsniveau

### Klinisk forskningsmetode
- Protokoludarbejdelse og deltagerinformation; VEK-ansøgning og -godkendelse; registrering på ClinicalTrials.gov
- Samtykkeindhentning, deltagerrekruttering, oplæring og opfølgning
- Systematisk dataindsamling og journaludtræk; databearbejdning og kvalitetssikring
- Statistisk analyse; metodesammenligning (vejet registrering vs. fotometode)
- Systematisk litteratursøgning (PICO) og kritisk vurdering af studiedesign

### Software & Tools
- **REDCap** — datamanagement i kliniske studier
- **VitaKost** — kostberegning og -bearbejdning
- **GraphPad Prism** — statistisk analyse og grafik
- **R-studio** — statistisk analyse (kursusniveau)
- **Sundhedsplatformen** — journal- og lab-dataudtræk
- Microsoft Office

## Publications
1. Bluming, J. et al. (in preparation). Klinisk tillægsstudie af nyrefunktion og calcium-/fosfatbalance hos stadie 4-5 kronisk nyresyge patienter, samt metodesammenligning af kostregistrering via vejet registrering vs. billedbaseret fotometode. **Manuscript in preparation — first author.**

<!-- Not yet published. In applications describe it as "under udarbejdelse til publicering som førsteforfatter" — never as a published paper. -->

## Awards
- None recorded

## Certifications & Authorisation
- **Autoriseret klinisk diætist** — dansk autorisation
- **Kørekort** — under erhvervelse, forventet klar nov. 2026
...
## References
- **Jens Rikardt Andersen**, MD, Københavns Universitet — specialevejleder (jra@nexs.ku.dk, +45 23 34 66 54)
- **Kirsten Thal Jantzen**, klinisk diætist, Herlev Hospital — vejleder, nefrologisk afdeling (kirsten.thal-jantzen@regionh.dk, +45 60 75 76 18)
- **Janne Christensen**, klinisk diætist, Rigshospitalet Glostrup — praktikvejleder (janne.christensen@regionh.dk, +45 38 63 22 27)

Yderligere referencer udleveres på forespørgsel.
